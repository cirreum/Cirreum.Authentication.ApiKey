...
/// required. Each value is <c>"ApiKey:" + </c> the corresponding well-known transport header name,
/// enforcing the <c>{Provider}:{Transport}</c> scheme-naming convention at the constant-definition site.
/// </summary>
/// <remarks>
...
public static class ApiKeySchemes {
	...
	/// <summary>Scheme name for the <see cref="ApiKeyTransport.Bearer"/> transport — <c>ApiKey:Bearer</c>.</summary>
	public const string Bearer = "ApiKey:" + ApiKeyTransports.Bearer;

	/// <summary>Scheme name for the <see cref="ApiKeyTransport.XApiKey"/> transport — <c>ApiKey:X-Api-Key</c>.</summary>
	public const string XApiKey = "ApiKey:" + ApiKeyTransports.XApiKey;

	/// <summary>Scheme name for the <see cref="ApiKeyTransport.OcpApimSubscriptionKey"/> transport — <c>ApiKey:Ocp-Apim-Subscription-Key</c>.</summary>
	public const string OcpApimSubscriptionKey = "ApiKey:" + ApiKeyTransports.OcpApimSubscriptionKey;

	/// <summary>Scheme name for the <see cref="ApiKeyTransport.XAuthToken"/> transport — <c>ApiKey:X-Auth-Token</c>.</summary>
